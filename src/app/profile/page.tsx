        ...
        <div className="flex justify-between items-center mb-12">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-lg font-light tracking-wide">Track your performance and achievements</p>
            </div>
          </div>
          <button
        ...
        <div className="flex gap-2 mb-12">
          {(['overview', 'badges', 'history'] as const).map((tab) => (
            <button
              ...
              className={`px-8 py-4 rounded-xl font-semibold transition-all duration-300 tracking-wide ${
                activeTab === tab
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-2xl">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-white">{stats.reliabilityScore.toFixed(1)}%</span>
                </div>
                <h3 className="text-gray-300 font-semibold mb-1">Reliability Score</h3>
                <p className="text-gray-400 text-sm">{getReliabilityLabel(stats.reliabilityScore)}</p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-2xl">
                ...
                <p className="text-gray-400 text-sm">{stats.completedShifts} completed</p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-2xl">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-white">${stats.totalEarnings.toFixed(0)}</span>
                </div>
                <h3 className="text-gray-300 font-semibold mb-1">Total Earnings</h3>
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-2xl">
                ...
                <h3 className="text-gray-300 font-semibold mb-1">Average Rating</h3>
                <p className="text-gray-400 text-sm">From managers</p>
              </div>
            </div>
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-300">Completed Shifts</span>
                    <span className="text-white font-bold">{stats.completedShifts}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-300">No Shows</span>
                    <span className="text-red-400 font-bold">{stats.noShows}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-300">Weekend Shifts</span>
                    <span className="text-white font-bold">{stats.weekendShifts}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-300">Morning Shifts</span>
                    <span className="text-white font-bold">{stats.morningShifts}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-300">Night Shifts</span>
                    <span className="text-white font-bold">{stats.nightShifts}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  {earnedBadges.slice(0, 3).map((badge) => (
                    <div key={badge.id} className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                  ...
                  {earnedBadges.length === 0 && (
                    <p className="text-gray-400 text-center py-8">Complete shifts to earn achievements!</p>
                  )}
                </div>
              </div>
            </div>
        ...
        {activeTab === 'history' && (
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="space-y-4">
                  ...
                  <div className="text-right">
                    ...
                    {shift.rating && (
                      <div className="flex items-center gap-1 justify-end mt-1">
                        ...
                        <span className="text-white text-sm">{shift.rating}</span>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {shifts.length === 0 && (
                <p className="text-gray-400 text-center py-8">No shifts completed yet</p>
              )}
            </div>
          </div>
        )}
